...
basvuruFormu.addEventListener("submit", function (event) {
    ...
    sonucAlani.innerHTML = `
        <div class="card shadow-sm" style="border:1.5px solid #38bdf8;border-radius:12px;">
            <div class="card-header d-flex align-items-center gap-2" style="background:#0c4a6e;border-bottom:1px solid #38bdf8;border-radius:10px 10px 0 0;">
                <span style="font-size:1.2rem;">✅</span>
                <strong style="color:#f0f9ff;">Başvuru Özeti</strong>
                <small class="ms-auto" style="color:#7dd3fc;opacity:0.85;">${tarihSaat}</small>
            </div>
            <div class="card-body">
            ...
            <div class="card-footer small" style="color:#38bdf8;border-top:1px solid rgba(56,189,248,0.2);">
